<template>
    <div>
        ...
        <template v-else>
            ...
            <input type="text" v-model='nodeKey'/>
            <br>
            <label class='w100'>Node Value:</label>
            <input type="text" v-model='nodeValue'/>
            <input type="button" value="SET" @click='set()'/>
            <input type="button" value="ADD" @click='add()'/>
            <input type="button" value="ADD_DIR" @click='addDir()'/>
  ...
  methods: {
    ...
    set() {
      if (this.nodeKey == this.editNode.node.key) {
        ...
        var value = new Buffer(this.nodeValue);
        this.zk.set(
          this.editNodeFullPath(),
          value,
          function() {
