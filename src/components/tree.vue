<template>
    <div :style="{'padding-left':'5px'}">
        ...
        <label v-text="keyValue" @click="nodeClicked()" @dblclick="nodeDbClicked()" locked=true></label>
...
export default {
    ...
    props: {
        ...
        node: { type: Object, "default": function () { return expamle_node; } },
        path: { type: String, "default": "" },
        zkGet: { type: Function, required: true }
    },
    computed: {
        keyValue: function () {
            return (this.node.key || "/") + (this.node.value ? ":" + this.node.value : "");
        }
    },
    data() {
        return {
    ...
    methods: {
        load() {
            ...
            var that = this;
            this.zkGet(nodePath, function (stat, data) {
